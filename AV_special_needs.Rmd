...
```
```{r}
wtrno %>% group_by(concern_safety) %>% summarise(n=n()) %>% mutate(freq=round(n/sum(n)*100,2))
```
```{r}
wtrno %>% group_by(concern_human) %>% summarise(n=n()) %>% mutate(freq=round(n/sum(n)*100,2))
```
```{r}
wtrno %>% group_by(concern_tech) %>% summarise(n=n()) %>% mutate(freq=round(n/sum(n)*100,2))
```
```{r}
wtrno %>% group_by(concern_other) %>% summarise(n=n()) %>% mutate(freq=round(n/sum(n)*100,2))
```
```{r}
